defmodule HomeWareWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HomeWareWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HomeWareWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  Use this component at the bottom of your layouts or pages.
  """
    ...
    <footer class="bg-gray-800 py-16 px-6">
      <div class="mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 class="text-2xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Vibe Needs
            </h3>
            <p class="text-gray-400 mb-4">
              Your premier destination for lifestyle products that enhance pleasure and relaxation.
            </p>
            <div class="flex space-x-4">
              <a
                href="#"
                class="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-purple-500 transition-colors"
              >
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              <li><a href="#" class="hover:text-purple-400 transition-colors">Shop</a></li>
              <li><a href="#" class="hover:text-purple-400 transition-colors">Categories</a></li>
              <li><a href="#" class="hover:text-purple-400 transition-colors">New Arrivals</a></li>
              <li><a href="#" class="hover:text-purple-400 transition-colors">Bestsellers</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li><a href="#" class="hover:text-purple-400 transition-colors">Shipping Info</a></li>
              <li><a href="#" class="hover:text-purple-400 transition-colors">Returns</a></li>
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li>
                <a href="#" class="hover:text-purple-400 transition-colors">Age Verification</a>
              </li>
              <li><a href="#" class="hover:text-purple-400 transition-colors">Disclaimers</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="border-t border-gray-700 pt-8">
          <div class="flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Vibe Needs. All rights reserved.
            </p>
            <div class="flex items-center space-x-4">
              <span class="text-red-400 font-bold text-lg">18+</span>
              <p class="text-gray-400 text-sm">
                Age verification required. Must be 18 or older to purchase.
              </p>
            </div>
          </div>
        </div>
